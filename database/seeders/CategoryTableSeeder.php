    ...
    public function run()
    {
        ...
        \DB::table("category")->insert([
            ...
            5 => [
                ...
                "image" => "1.jpg",
                "description" =>
                    "<div>Shop for the Best Car Accessories at the best price in Kenya. Choose from a wide range of supplementary Components such as Jump stater, Smartphone holders FM expanders and many more.<br><br>Our Car Accessory products are suitable for all car types.</div><br><br><br><br>",
                "col" => "2",
